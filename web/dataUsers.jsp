            ...
            <div class="container-fluid d-flex">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a style="color:#eb5d1e" href="dataUsers.jsp">Data Users</a></li>
                        ...
                        <div class="col-lg-12 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                            ...
                            <% if (request.getParameter("Approved") != null) { %>
                                <div class="alert alert-success text-center font-weight-bold" style="font-size: 16px; margin: 15px 0;">
                                    <i class="icofont-check-circled"></i> Data User Account Approved Successfully! Notification dispatched.
                                </div>
                            <% } %>
                            <% if (request.getParameter("Deleted") != null) { %>
                                <div class="alert alert-success text-center font-weight-bold" style="font-size: 16px; margin: 15px 0;">
                                    <i class="icofont-check-circled"></i> Data User Account Deleted Successfully!
                                </div>
                            <% } %>
                            <% if (request.getParameter("Updated") != null) { %>
                                <div class="alert alert-info text-center font-weight-bold" style="font-size: 16px; margin: 15px 0;">
                                    <i class="icofont-refresh"></i> Data User Status Updated Successfully!
                                </div>
                            <% } %>
                            ...
                            <table id="customers">
                                    ...
                                    <%try {
                                            ...
                                            String sql = "select * from du_reg ORDER BY id DESC";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <% if("Approved".equalsIgnoreCase(status)) { %>
                                                <a href="taToggleDU.jsp?id=<%=uid%>&status=Revoked" class="btn btn-warning btn-sm" onclick="return confirm('Are you sure you want to revoke this Data User?');">Revoke</a>
                                            <% } else { %>
                                                <a href="duApprove.jsp?id=<%=uid%>" class="btn btn-success btn-sm">Approve</a>
                                            <% } %>
                                            <a href="taDeleteDU.jsp?id=<%=uid%>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Data User account?');">
