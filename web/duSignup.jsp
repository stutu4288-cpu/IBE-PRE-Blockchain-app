        ...
        <main id="main" style="padding-top: 90px;">
            ...
            <section id="contact" class="contact">
                <div class="container" data-aos="fade-up">               
                    <center><h3>Data User Registration</h3></center><br>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <form action="duReg" method="post" id="duSignupForm" role="form" onsubmit="return validateForm();">
                                <div class="form-row">
                                ...
                                <div class="form-group mt-3">
                                    <div class="text-center">
                                        ...
                                        <a href="duLogin.jsp" class="btn btn-secondary btn-lg px-4 ml-2">Back to Login</a>
                                    </div>
                                </div>
                            </form>
                        </div>
