                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <% if (request.getParameter("Register_Success") != null) { %>
                        <div class="alert alert-success alert-dismissible fade show text-center py-3 shadow-sm mb-4" role="alert" style="border-left: 5px solid #198754; background-color: #f8fff9;">
                            ...
                            <p class="mb-0 text-dark" style="font-size: 15px;">
                                Your Data Owner account has been created. It is currently <b>Pending Approval</b> by the Trusted Authority. Once approved, you can log in below.
                            </p>
                    ...
                    <% if ("Account_Pending".equals(request.getParameter("msg"))) { %>
                        <div class="alert alert-warning alert-dismissible fade show text-center py-3 shadow-sm mb-4" role="alert" style="border-left: 5px solid #ffc107;">
                            ...
                            <p class="mb-0 text-dark" style="font-size: 14px;">
                                The Trusted Authority has not yet approved your Data Owner account. Please contact TA administrator for activation.
                            </p>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        ...
                        <div class="col-lg-6">
                            <form action="doSignin.jsp" method="post" role="form" id="doLoginForm" onsubmit="return validateLoginForm();">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">e.g. sikapa, 0557185634, or name@gmail.com</small>
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold">Private Key (Optional) :</label>
                                    <input type="text" class="form-control" name="pkey" id="pkey" placeholder="Base64 Private Key (e.g. VAC4uFdeRe8=)" />
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <hr>
                                    <p class="mb-1">Don't have an account? <a href="doSignup.jsp" class="font-weight-bold text-primary">Register Here</a></p>
