        ...
        <header id="header" class="fixed-top">
            <div class="container-fluid d-flex">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        <li><a style="color:#eb5d1e" href="cspHome.jsp">Home</a></li>
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-12 content text-center" data-aos="fade-right" data-aos-delay="100">
                            <h3 class="mb-2">Welcome to Cloud Service Provider Portal!</h3>
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-md-4 m-2 p-3 bg-light rounded border text-center">
                                    <h5 style="color:#eb5d1e;">Cloud Stored Files</h5>
                                    <p class="text-muted small mb-2">View encrypted files and cloud blocks</p>
                                    <a href="cloudFiles.jsp" class="btn btn-primary btn-sm">View Cloud Files</a>
                                </div>
                                <div class="col-md-4 m-2 p-3 bg-light rounded border text-center">
                                    <h5 style="color:#eb5d1e;">Performance Graph</h5>
                                    <p class="text-muted small mb-2">View encryption performance analytics</p>
                                    <a href="graph.jsp" class="btn btn-primary btn-sm">View Analytics</a>
                                </div>
                            </div>
                        </div>
                    </div>
