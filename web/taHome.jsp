            ...
            <div class="container-fluid d-flex">
                ...
                <nav class="nav-menu d-none d-lg-block">
                    <ul>
                        ...
                        <li><a href="taAuditLog.jsp">Audit Log</a></li>
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        <div class="col-lg-12 content text-center" data-aos="fade-right" data-aos-delay="100">
                            <h3 class="mb-2">Welcome to Trusted Authority Portal!</h3>
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-md-3 m-2 p-3 bg-light rounded border text-center">
                                    ...
                                    <p class="text-muted small mb-2">Manage & approve data owners</p>
                                    <a href="dataOwners.jsp" class="btn btn-primary btn-sm">View Owners</a>
                                </div>
                                <div class="col-md-3 m-2 p-3 bg-light rounded border text-center">
                                    <h5 style="color:#eb5d1e;">Data Users</h5>
                                    <p class="text-muted small mb-2">Manage registered recipients</p>
                                    <a href="dataUsers.jsp" class="btn btn-primary btn-sm">View Users</a>
                                </div>
                                <div class="col-md-3 m-2 p-3 bg-light rounded border text-center">
                                    <h5 style="color:#eb5d1e;">Requested Files</h5>
                                    <p class="text-muted small mb-2">Review file requests</p>
