                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10 content text-center" data-aos="fade-right" data-aos-delay="100">
                            ...
                            <!-- Data User Security & Decryption Cards -->
                            <div class="row mt-4 justify-content-center">
                                <div class="col-md-6 mb-3">
                                    <div class="card shadow-sm border-0 h-100">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title text-primary font-weight-bold">Decryption Rights via Proxy</h5>
                                ...
                                <div class="col-md-5 mb-3">
                                    <div class="card shadow-sm border-0 h-100">
                                        <img src="assets/img/smart_contract_concept.png" class="card-img-top" alt="Smart Contract Policy" style="max-height: 250px; object-fit: contain; background: #f8f9fa;">
                                        <div class="card-body">
                                            <h5 class="card-title text-primary font-weight-bold">Ethereum Access Policy</h5>
